...
def evaluate_answer(subject: str, question: str, correct_answer: str, student_answer: str) -> dict:
    """Evaluate the student's answer using Ollama, or fallback to keyword matching."""
    if check_ollama():
        return _evaluate_with_ollama(subject, question, correct_answer, student_answer)
    else:
        return _evaluate_with_fallback(correct_answer, student_answer)

def _evaluate_with_ollama(subject: str, question: str, correct_answer: str, student_answer: str) -> dict:
...
def _evaluate_with_fallback(correct_answer: str, student_answer: str) -> dict:
